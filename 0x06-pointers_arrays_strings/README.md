<h1 class="gap">0x06. C - More pointers, arrays and strings</h1><div class="gap" id="project-description">
<p><img alt="" src="/images/contents/low_level_programming/projects/happy-clapping.gif" style=""/></p>
<h2>Requirements</h2>
<h3>General</h3>
<ul>
